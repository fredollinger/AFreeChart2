AFreeChart2 : version 0.0.5

Current maintainer:

Frederick Ollinger <follinge@gmail.com>

Fork the original project because it's been dead for a long time.

Goal is to get building in the newer versions of Android Studio as
well as to continue to maintain this project.

Finally, we hope to possibly port over new features from JFreeChart
in the future as needed by other projects.

I did not write this code, but rather ported it.

Original authorship is maintained.

(C) Copyright 2010,2011 by ICOMSYSTECH Co.,Ltd.

The last version of the original AFreeChart can be obtained from:
